...
// Base URL for API - set via environment variable VITE_API_URL
// Production: Set in Render dashboard or .env.production
// Local dev: Create .env.local with VITE_API_URL=http://localhost:8080/api
